...
EPIC_MONO=""
if [ -f "D:\Program Files (x86)\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\Program Files (x86)\UE_4.23\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'D:\Program Files (x86)\UE_4.23\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
